...
//TODO Preserve shared channel indexes.
{
    ...
    private _channelName = "";
    {
        ...
        // Create Presets....
        {
            ...
            if (!_return) then {
                private _radioPresetData = createLocation ["ACRE_FastHashNamespaceDummy", [-10000,-10000,-10000], 0, 0];//HASH_CREATE;
                
                _channels = [];
                for "_i" from 0 to 15 do {
                    private _channel = createLocation ["ACRE_FastHashNamespaceDummy", [-10000,-10000,-10000], 0, 0];//;HASHLIST_CREATEHASH(_channels);
